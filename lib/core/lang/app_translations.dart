...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'zh_CN': {
      ...
      'jump_2_send_event_page': '跳转发送事件页面',
    ...
    'en_US': {
      ...
      'jump_2_send_event_page': 'Redirect to the event sending page',
      ...
      'list_page': 'List Page',
      'common_component_button_style': 'General component/button style encapsulation',
